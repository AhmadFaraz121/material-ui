...
export default function CallToAction(props){
    ...
    return <Grid container alignItems="center" justify={matchesSM ? "center" : "space-between"} className={classes.background} direction={matchesSM ? "column" : "row"}>
            ...
            <Grid container direction="column">
                <Grid item>
                    ...
                    <Grid container justify={matchesSM ? "center" : undefined} item>
                        <Button variant="outlined" component={Link} href="/revolution" className={classes.learnButton} onClick={()=>props.setValue(2)}>
        ...
        <Grid item>
            <Button variant="contained" component={Link} href="/estimate" className={classes.estimateButton} onClick={()=>props.setValue(5)}>Free Estimate</Button>
        </Grid>
    </Grid>
}